// Custom SOD-123FL flat-lead footprint for the Littelfuse SMF3.3CA data-line TVS.
...
// 3.0 x 1.85mm) adapted to through-hole. See ../../AGENTS.md "TRRS Data-line Protection".
module.exports = {
    params: {
    ...
    body: p => `
        (footprint "splinter:D_SOD-123FL_HandSolder"
            ...
            (fp_text value "SMF3.3CA" (at 0 2 ${p.rot}) (layer "F.Fab") hide
                (effects (font (size 0.8 0.8) (thickness 0.12)))
            )
            ...
            ${''/* Pad "K" = cathode (banded end) = 'to' net; pad "A" = anode = 'from' net.
                  SMF3.3CA is bidirectional so orientation is electrically irrelevant; for a
