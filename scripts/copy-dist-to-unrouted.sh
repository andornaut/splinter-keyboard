...
require_pcbs "$src_dir" "No generated PCBs in ${src_dir}/ -- run 'npm run ergogen' first."
...
ok "copy:dist-to-unrouted: ${#files[@]} PCB(s) copied to ${dst_dir}/ (backups in ${backup_dir}/)"
