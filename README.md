...
| [v3](./v3) | [Adafruit KB2040](https://www.adafruit.com/product/5302) (RP2040)                                          | Switched from AVR to RP2040                                        | [splinter-3.0](https://github.com/andornaut/qmk_firmware/tree/splinter-3.0/keyboards/splinter) | [![v3](./v3/v3-300width.jpg)](./v3/v3.jpg) |
| [v2](./v2) | [SparkFun Pro Micro](https://www.sparkfun.com/sparkfun-qwiic-pro-micro-usb-c-atmega32u4.html) (ATmega32U4) | Symmetrical enclosures; added a key (62 keys)                      | [splinter-2.0](https://github.com/andornaut/qmk_firmware/tree/splinter-2.0/keyboards/splinter) | [![v2](./v2/v2-300width.jpg)](./v2/v2.jpg) |
| [v1](./v1) | [SparkFun Pro Micro](https://www.sparkfun.com/sparkfun-qwiic-pro-micro-usb-c-atmega32u4.html) (ATmega32U4) | Initial version: 61 keys, columnar layout, asymmetrical enclosures | [splinter-1.0](https://github.com/andornaut/qmk_firmware/tree/splinter-1.0/keyboards/splinter) | [![v1](./v1/v1-300width.jpg)](./v1/v1.jpg) |
...
A stamp names the commit the build's _inputs_ came from, never the commit that contains the stamped board: the stamp is written into the board, so it can only name its own parent. To get the boards a stamp describes, check that commit out and rebuild.
...
Taking `kicad/routed/*.kicad_pcb` straight from that commit instead gives you the _previous_ build's masters. Rebuilding reproduces copper, drill, mask, paste, outline and the assembly files identically; only the `built=` timestamp drawn on the silk and a few microns of teardrop fill tessellation differ.
