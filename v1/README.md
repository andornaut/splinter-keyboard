...
Position each PCB at (105,105). The left half starts at this position, but the right half must be moved before running `npm run copy-traces-from-routed`. 100mm to provide a buffer around the edges of the document, and 5 mm to account for the case walls.
